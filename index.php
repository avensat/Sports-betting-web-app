...
if(isset($_POST['Submit']))
	{
		...
		if(empty($_POST['password1'])){
			...
			$p= mysqli_real_escape_string($connect,$_POST['password1']);
		}
...
$login= mysqli_query($connect,"SELECT * 
				FROM registration 
				WHERE Username='$u' && password1='$p'") or die('could not login'.mysqli_error($connect));
...
$sql= mysqli_query($connect,"update registration set view=view+1") or die('could not update'.mysqli_error($connect));
...
$query = mysqli_query($connect,"SELECT * FROM livematches order by match_id desc limit 0,7") or die('could not select'.mysqli_error($connect));
...
$query_2= mysqli_query($connect,"SELECT * FROM upcomingevents 
						order by match_id desc limit 0,15 ") or die('could not select'.mysqli_error($connect));
